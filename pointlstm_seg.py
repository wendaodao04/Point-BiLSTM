...
class Point_Transformer_partseg(nn.Module):
    def __init__(self, part_num=50):
        ...
        self.lstm1 = nn.LSTM(input_size=128, hidden_size=128, num_layers=2, batch_first=True, bias=True, bidirectional=True)
        self.lstm2 = nn.LSTM(input_size=256, hidden_size=256, num_layers=2, batch_first=True, bias=True, bidirectional=True)
        # self.lstm2 = nn.LSTM(input_size=128, hidden_size=64, num_layers=2, batch_first=True, bias=True, bidirectional=True)
        # self.lstm3 = nn.LSTM(input_size=128, hidden_size=128, num_layers=2, batch_first=True, bias=True, bidirectional=True)
        # self.lstm4 = nn.LSTM(input_size=128, hidden_size=128, num_layers=2, batch_first=True, bias=True, bidirectional=True)
        ...
        self.lstm3 = nn.LSTM(input_size=64, hidden_size=64, num_layers=2, batch_first=True, bias=True, bidirectional=True)
        self.lstm4 = nn.LSTM(input_size=128, hidden_size=128, num_layers=2, batch_first=True, bias=True, bidirectional=True)
...
class Point_Transformer_partseg1(nn.Module):
    def __init__(self, part_num=50):
        super(Point_Transformer_partseg1, self).__init__()
        self.part_num = part_num
        self.conv1 = nn.Conv1d(6, 128, kernel_size=1, bias=False)
        self.conv2 = nn.Conv1d(128, 128, kernel_size=1, bias=False)
        ...
        # self.convs3 = nn.Conv1d(2048, 1024, 1)
        # self.convs4 = nn.Conv1d(1024 512, 1)
        
        # self.lstm3 = nn.LSTM(input_size=256, hidden_size=256, num_layers=2, batch_first=True, bias=True, bidirectional=True)
        # self.lstm4 = nn.LSTM(input_size=2048, hidden_size=2048, num_layers=2, batch_first=True, bias=True, bidirectional=True)
    ...
    def forward(self, x, norm_plt, cls_label):
        ...
        # x3, _ = self.lstm1(cls_label_feature)
        # x4, _ = self.lstm2(x3)
        # x = x4.permute(0,2,1)
...
class Point_Transformer_partseg2(nn.Module):
    def __init__(self, part_num=50):
        super(Point_Transformer_partseg2, self).__init__()
        self.part_num = part_num
        self.conv1 = nn.Conv1d(6, 128, kernel_size=1, bias=False)
        self.conv2 = nn.Conv1d(128, 128, kernel_size=1, bias=False)
    ...
    def forward(self, x, norm_plt, cls_label):
        ...
        x1 = x1.permute(0,2,1)
        # print("x1", x1.shape)
        x1 = self.relu(self.bn1_1(self.conv1_1(x1)))
        # print("x1*", x1.shape)
        x1 = x1.permute(0,2,1)
...
class Point_Transformer_partseg3(nn.Module):
    def __init__(self, part_num=50):
        super(Point_Transformer_partseg3, self).__init__()
        self.part_num = part_num
        self.conv1 = nn.Conv1d(6, 128, kernel_size=1, bias=False)
        self.bn1 = nn.BatchNorm1d(128)
